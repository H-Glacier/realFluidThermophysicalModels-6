...
Foam::psiReactionThermo::forcedMaxRootCells() const
{
    return Foam::basicThermo::forcedMaxRootCells();
}

Foam::label
Foam::psiReactionThermo::nForcedMaxRootCells() const
{
    return Foam::basicThermo::nForcedMaxRootCells();
}
